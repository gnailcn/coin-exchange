...
import com.gnailcn.domain.UserFavoriteMarket;
import com.gnailcn.model.R;
import com.gnailcn.service.MarketService;
import com.gnailcn.service.UserFavoriteMarketService;
...
public class UserFavoriteMarketController {
    ...
    public R addFavorite(@RequestBody Market market) {
        ...
        @NotNull String symbol = market.getSymbol(); // 市场的symbol, 例如BTC/USDT
