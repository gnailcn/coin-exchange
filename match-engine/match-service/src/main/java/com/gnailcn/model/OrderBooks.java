...
public class OrderBooks {
    ...
    public void addOrder(Order order) {
        OrderDirection direction = OrderDirection.getOrderDirection(order.getOrderDirection()); //int转为枚举类型
        TreeMap<BigDecimal, MergeOrder> currentLimitPrices = getCurrentLimitPrices(direction);
