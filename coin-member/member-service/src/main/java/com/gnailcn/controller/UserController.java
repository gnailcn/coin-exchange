...
import com.gnailcn.domain.User;
import com.gnailcn.domain.UserAuthAuditRecord;
import com.gnailcn.domain.UserAuthInfo;
import com.gnailcn.dto.UserDto;
import com.gnailcn.feign.UserServiceFeign;
import com.gnailcn.model.*;
import com.gnailcn.service.UserAuthAuditRecordService;
import com.gnailcn.service.UserAuthInfoService;
import com.gnailcn.service.UserService;
import com.gnailcn.vo.UseAuthInfoVo;
...
public class UserController implements UserServiceFeign {
    ...
    //required = true 表示必须传递的参数, 不能为空， 与@validated相比，@RequestParam更加灵活
    ...
    @ApiOperation(value = "用户的实名认证")    //也就是姓名+身份证号码
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "用户进行高级认证")   //证件照
    @ApiImplicitParams({
